...
class gsp_atividades_categoriashow_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("categoria")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.categoria)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.categoria),'method':("DELETE")],2)
printHtmlPart(17)
})
