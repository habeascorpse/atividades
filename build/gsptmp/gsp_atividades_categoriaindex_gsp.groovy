...
class gsp_atividades_categoriaindex_gsp extends GroovyPage {
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(categoriaList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(categoriaCount ?: 0)],-1)
printHtmlPart(13)
})
